            ...
            <div className="grow-6" style={{ width: "50%" }}>
              <div>
                ...
                <div className="">
                  <strong>
                    {" "}
                    <span className="pricing__price teal--text">$2 </span>for up
                    to 5 edits
                  </strong>
                </div>
                <div className="">
                  <strong>
                    {" "}
                    <span className="pricing__price teal--text">$5 </span>for
            ...
            <div className="grow-6" style={{ width: "50%" }}>
              <div>
                ...
                <div className="">
                  <strong>
                    {" "}
                    <span className="pricing__price teal--text">$10 </span>for
                    up to 5 edits
                  </strong>
                </div>
                <div className="">
                  <strong>
                    {" "}
                    <span className="pricing__price teal--text">$20 </span>for
                    unlimited per 3 screens
                  </strong>
                </div>
              </div>
            ...
            <div className="grow-6" style={{ width: "50%" }}>
              <div>
                ...
                <div className="">
                  <strong>
                    {" "}
                    <span className="pricing__price teal--text">$15 </span>for
                    up to 5 types
                  </strong>
                </div>
                <div className="">
                  <strong>
                    {" "}
                    <span className="pricing__price teal--text">$50 </span>new
                    form
                  </strong>
