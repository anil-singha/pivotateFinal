    ...
    <div className="container">
      <div id="placeholders">
        ...
        <p>
          ...
          use of{" "}
          <span className="highlight preview_company_name">Pivotate</span>'s
          Website, located at{" "}
          <span className="highlight preview_website_url">pivotate.com</span>.
        </p>
        <p>
        ...
        <p>
          ...
          <span className="highlight preview_company_name">NoStack</span>'s
          Privacy Policy.
        </p>
        <p>
        ...
        <p>
          You hereby grant{" "}
          <span className="highlight preview_company_name">NoStack</span> a
