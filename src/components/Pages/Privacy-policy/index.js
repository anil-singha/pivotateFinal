  ...
  return (
    <div class="container full-width-sm">
      <div class="row">
        ...
        <h2 id="chat-rooms-or-forums">Disclosure in Chat Rooms or Forums</h2>
        <p>
        ...
        <h2 id="changes-to-privacy-policy">Updates to This Privacy Policy</h2>
        <p>
