...
function UserTypeCreationForm({
  ...
  createUserType,
  refetchQueries,
  // ns__custom_start unit: appInfo, comp: UserTypeCreationForm, loc: addedPropsForCreationForm
  validateUserTypes,
  onChange,
  label,
  ...
  disabled,
  textLabel,
  // ns__custom_end unit: appInfo, comp: UserTypeCreationForm, loc: addedPropsForCreationForm
}) {
