...
function DescriptionCreationForm({
  ...
  createDescription,
  refetchQueries,
  // ns__custom_start unit: appInfo, comp: DescriptionCreationForm, loc: addedPropsForCreationForm
  label,
  // ns__custom_end unit: appInfo, comp: DescriptionCreationForm, loc: addedPropsForCreationForm
}) {
  ...
  function handleKeyPress(e) {
    // ns__custom_start unit: appInfo, comp: DescriptionCreationForm, loc: insideHandleKeyPress
    // if (e.charCode === 13) {
    //   handleSubmit(e);
    // }
    if (e.key === 'Enter') {
