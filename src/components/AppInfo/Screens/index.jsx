 ...
 */
// ns__file unit: appInfo, comp: Screens

// ns__custom_start unit: appInfo, comp: Screens, loc: beforeImports
// ns__custom_end unit: appInfo, comp: Screens, loc: beforeImports
...
// ns__custom_start unit: appInfo, comp: Screens, loc: styling
...
const Button = styled.button`
  ...
  margin: 0 auto;
`;
// ns__custom_end unit: appInfo, comp: Screens, loc: styling

class Screens extends Component {
  state = {
    selectedScreenId: null,
    // ns__custom_start unit: appInfo, comp: Screens, loc: addedState
    infoTypeValueCount: 0,
    // ns__custom_end unit: appInfo, comp: Screens, loc: addedState
  };
  ...
  render() {
    ...
    // ns__custom_start unit: appInfo, comp: UserTypes, loc: beginning
    const {label} = this.props;
    const validateScreens = screens.length;
    const { infoTypeValueCount } = this.state;
    
    // ns__custom_end unit: appInfo, comp: UserTypes, loc: beginning

    // ns__custom_start unit: appInfo, comp: Screens, loc: renderBeginning
    return (
      <>
        <ScreensStyleWrapper ref={this.wrapperRef} onClick={this.handleClick}>
          ...
          {/* ns__custom_start unit: appInfo, comp: Screens, loc: renderEnding */}
          {/* ns__custom_end unit: appInfo, comp: Screens, loc: renderEnding */}
        </ScreensStyleWrapper>
        <ScreenCreationForm
          parentId={userTypeId}
          refetchQueries={refetchQueries}
          /* ns__custom_start unit: appInfo, comp: Screens, loc: addedProps */
          validateScreens={validateScreens}
          onChange={this.onChangeHelper}
          label={label}
          /* ns__custom_end unit: appInfo, comp: Screens, loc: addedProps */
        />
    ...
    // ns__custom_end unit: appInfo, comp: Screens, loc: renderBeginning
