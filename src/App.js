            ...
            <div className="flex items-center">
              <div className="hero__header">
                ...
                <p>
                  ...
                  allow you to change it almost as easily as if you had your own
                  team.
                </p>
          ...
          <div className="container">
            <div className="flex items-center">
              ...
              <p className="about__text">
                ...
                <br />
                <br />
                Pivotate offers a more natural approach than freelancer sites
                and outsourcing companies. We maintain a very flexible version
                of your app. You can work in small, inexpensive steps.
                <br />
                <br />
          ...
          <div className="flex flex-column ">
            ...
            <div className="container full-width flex items-center">
              <p className="why-it-works__text">
                Our framework makes coding simpler and easier. The developer
                just works on the user interface.
              </p>
              <img
